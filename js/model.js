...
var carouselTabHTML = "<li id='gallery-pill'>" +
                      "<a class='pill-text' data-toggle='pill' href='#pill-gallery'>Gallery</a></li>";
var carouselHTML = "<div class='tab-pane' id='pill-gallery'>" +
                   "<div class='modal-gallery' id='gallery-tab'>" +
                   "<div id='gallery'>" +
                   "<div id='gallery-header'>" +
                   "<div class='carousel slide' data-ride='carousel' id='carousel-images'>" +
                   "<ol class='carousel-indicators' data-bind='foreach: fsImg'>" +
                   "<li data-bind='attr: { 'data-slide-to': $index }' data-target='#carousel-images' id='carousel-control'></li>" +
                   "</ol>" +
                   "<div class='carousel-inner' data-bind='foreach: fsImg' role='listbox'>" +
                   "<div class='item' id='carousel-item'><img alt='Park picture' class='img-responsive' data-bind='attr: {src: $data}' id='fsImage'></div>" +
                   "</div><a class='left carousel-control' data-slide='prev' href='#carousel-images' role='button'><span aria-hidden='true' class='glyphicon glyphicon-chevron-left'></span> <span class='sr-only'>Previous</span></a> <a class='right carousel-control' data-slide='next' href='#carousel-images' role='button'><span aria-hidden='true' class='glyphicon glyphicon-chevron-right'></span> <span class='sr-only'>Next</span></a>" +
                   "</div>" +
                   "</div>" +
                   "</div>" +
                   "</div>" +
